...
//  Инициализируем appBarExpand - булевый (логический) флаг, который указывает на то,
//  когда AppBarLayout будет свернут или развернут.
//  Предустановим true - развернут.
//  Поскольку изначально мы видим развернутую картинку, а не просто Toolbar.
...
// пользовательское поведение на основе смещения (например, привязка представления к определенному значению y).
        ...
        collapsAppbar.addOnOffsetChangedListener((appBarLayout, verticalOffset) -> {
...
// При наличии обозначения Add, элемент меню, в случае нажатия на него,
// запустит соответствующее действие,
