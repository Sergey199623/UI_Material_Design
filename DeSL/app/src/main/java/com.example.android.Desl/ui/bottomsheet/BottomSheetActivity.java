package com.example.android.Desl.bottomsheet;
...
// FAB изменяется при движении нижней панели.
    ...
    private void initBsModal() {
        ...
        View bsModal = getLayoutInflater()
                .inflate(R.layout.bottom_sheet_modal, bsPersistent, false);
        ...
        btnFile = bsModal.findViewById(R.id.btn_file);
        btnGallery = bsModal.findViewById(R.id.btn_gallery);
        btnSd = bsModal.findViewById(R.id.btn_sd);
